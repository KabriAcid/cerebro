    ...
    <main class="container py-4">
        ...
        <section class="profile-section mb-4 bg-white shadow p-3 rounded">
            <div class="d-flex justify-content-between align-items-center">
                <img src="../assets/img/default.png" alt="Profile Picture" class="rounded-circle me-3" width="60" height="60">
        ...
        <section class="application-section mb-4">
            <h6 class="text-muted mb-2 small">APPLICATION</h6>
            <ul class="list-group">
                ...
                <li class="cursor-pointer list-group-item d-flex justify-content-between align-items-center" onclick="window.location.href='chat-history.php'">
                    Chat history
        ...
        <section class="about-section">
            <h6 class="text-muted mb-2 small">ABOUT</h6>
            <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    Help Center
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right text-muted" viewBox="0 0 16 16">
        ...
        <div class="d-flex justify-content-center mt-4">
            <p class="text-sm"><a href="dashboard.php" class="btn mini-btn">Back</a></p>
        </div>
    </main>
</body>
